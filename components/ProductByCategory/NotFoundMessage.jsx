  ...
  return (
    ...
    >
      ...
      <div className="relative  flex flex-col items-center justify-center text-center  ">
        <MdInfo className="text-5xl mb-4" />
        <p className="text-xl sm:text-2xl mb-4 font-montserrat">
        ...
        <Link
          href="/"
          className={`bg-gray-700 text-white uppercase font-montserrat border border-transparent rounded-md shadow-sm py-3 px-4 tracking-wide  text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-indigo-500`}
        >
          GO BACK TO HOMEPAGE
        </Link>
      </div>
