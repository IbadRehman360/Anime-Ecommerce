  ...
  return (
    <div className="grid grid-cols-1   md:grid-cols-2">
      ...
      <div
        ...
        border-r  pt-4    pb-16 lg:pb-20 md:py-28 flex-auto items-center justify-center px-5 sm:px-10 lg:p-10 overflow-hidden   text-white bg-no-repeat "
      >
        <div className="w-full max-w-md z-10">
          <h2 className="text-[1.6rem] sm:text-[1.7rem]  font-montserrat leading-9     uppercase   font-bold    text-center  text-black">
            {isCurrently ? "  Login " : " Register "}
          </h2>
          <div className=" mt-4 lg:mt-5 text-center">
            {isCurrently ? (
              <p className="text-gray-600  text-[0.92rem] lg:text-[1rem]  tracking-wide leading-6">
              ...
              <p className="text-gray-600  text-[0.92rem] lg:text-[1rem]  tracking-wide leading-6">
                Sign in to Your Account for Instant Order Updates and an
                Expansive Exploration of Your Order History! Your journey
                continues as you enter your login credentials below, unlocking a
                gateway to a shopping experience tailored just for you
              </p>
            )}
          </div>
          <div />
        ...
        <div class="hidden absolute bottom-0    right-0 lg:flex items-center justify-center flex-1 bg-white text-black">
      ...
      <div className="   order-first border-r-2 opacity-90  py-8  pt-12 md:py-28  bg-white ">
