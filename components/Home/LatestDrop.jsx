  ...
  return (
    <div className="pt-8 pb-6 sm:pb-8 lg:pb-10 mx-auto md:px-6 px-2 py-2 w-full">
      <div className="text-center pb-0.5">
        <h2 className="  font-montserrat text-[1.8rem]  px-2   leading-9  font-extrabold sm:text-[2.2rem] lg:text-[2.6rem] uppercase mb-1 text-gray-900 tracking-wider text-center lg:mt-6">
          OTAKU ACCESSORIES
        </h2>
      </div>
