    ...
    <div className="bg-white">
      <div className="">
        ...
        <div className="mx-auto max-w-2xl px-4 pb-16 pt-6  sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <div className=" flex justify-between">
              ...
              <div className="flex items-center -mt-[6px] ">
                ...
                <a
                  href={reviews.href}
                  className="ml-2 text-xs sm:text-sm  font-medium text-indigo-600 hover:text-indigo-500"
                >
          ...
          <div className="  font-satoshi line-through tracking-wider  text-sm     text-gray-500">
            <span className="tracking-normal   mr-1"> Rs.</span>
            {product.discountedPrice}.00
          </div>
          <div className="mt-6 pb-8">
            <h3 className="sr-only  font-bungee tracking-tighter text-black">
              Highlights
            </h3>
            ...
            <div className="flex flex-wrap">
              <div className="w-full    ">
                <div className="flex items-center  py-6 gap-2 justify-between">
                  <div className="flex   border   border-gray-400 rounded-md bg-[#f5f5f5]  ">
                    <button
                  ...
                  <button
                    type="submit"
                    className=" flex w-full items-center text-sm justify-center rounded-md border border-transparent bg-slate-800 py-2.5 uppercase  font-medium text-white hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                  >
                    Add to Cart
                  </button>
                </div>
                ...
                <button
                  type="submit"
                  className="  flex w-full items-center justify-center rounded-md border border-transparent bg-slate-800      uppercase  py-3 text-sm font-medium text-white hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                >
                  Add to bag
                </button>
              </div>
          ...
          <div>
            <div className="space-y-6">
              <div className="border-b border-gray-300 pb-4">
                <div className="flex items-center justify-between">
                  <h4 className="font-bungee tracking-tighter text-black">
                    Description
                  </h4>
